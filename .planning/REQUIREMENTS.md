...
- [x] **OCR-02**: AI expands abbreviated item names into readable names (e.g. "CHKN SAND" → "Chicken Sandwich")
- [x] **OCR-03**: User can review and edit extracted items before assigning
- [x] **OCR-04**: When items are ambiguous, user can take a menu photo OR enter the name manually
