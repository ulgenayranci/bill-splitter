              ...
              <div ref={activeFormRef} className="flex flex-col gap-1">
                <Card className={`flex flex-row items-center gap-2 px-4 py-3 transition-colors ${formHighlight ? 'ring-2 ring-red-400 border-red-400' : ''}`}>
                  ...
                  <button
                    ...
                    className="flex h-10 w-10 items-center justify-center rounded-md border border-border bg-white text-zinc-700"
                  >
                    <Check size={18} />
                  </button>
                  <button
                    ...
                    className="flex h-10 w-10 items-center justify-center rounded-md border border-border bg-white text-zinc-400"
                  >
                    <X size={18} />
                  </button>
                </Card>
